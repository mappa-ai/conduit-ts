...
type MediaSpeaker = {
  speakerIndex: number;
  speechSeconds: number; /** Full text spoken by this speaker across the recording. */
  transcript: string;
};
type MediaSpeakers = {
  mediaId: string;
